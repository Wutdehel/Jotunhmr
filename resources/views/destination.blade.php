...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="{{ url('welcome') }}">Jötunheimr<span>Travel Agency</span></a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a href="{{ url('destination') }}" class="nav-link">Destination</a></li>
        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate pb-5 text-center">
                    <p class="breadcrumbs"><span class="mr-2"><a href="{{ url('welcome') }}">Home <i
    ...
    <section class="ftco-section">
        <div class="container">
            <div class="row">
                @foreach($paketwisata->slice(0, 12) as $key => $data)
                <div class="col-md-4 ftco-animate">
                    <div class="project-wrap">
                        <a href="{{route('reservasi.create')}}" class="img" style="background-image: url('storage/{{$data->foto1}}');">
                            <span class="price">Rp.{{$data->harga_per_pack}}</span>
                        </a>
                        <div class="text p-4">
                            <span class="days">{{$data->fasilitas}}</span>
                            <h3><a href="#">{{$data->nama_paket}}</a></h3>
                            <p class="location"><span class="fa fa-map-marker"></span>{{$data->deskripsi}}</p>
                            <ul>
                                <li><span class="flaticon-mountains"></span>Discount {{$data->diskon}}%</li>
                            </ul>
                        </div>
                    </div>
                </div>
